...
| **4일차** | [파이썬 종합 실습 및 프로젝트 준비](04%EC%9D%BC%EC%B0%A8%20-%20%ED%8C%8C%EC%9D%B4%EC%8D%AC%20%EC%A2%85%ED%95%A9%20%EC%8B%A4%EC%8A%B5%20%EB%B0%8F%20%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%20%EC%A4%80%EB%B9%84.md) | 1~3일차 복습 + 실전 실습<br>프로젝트 아이디어 구체화<br>개발 계획 수립                     | 프로젝트 정의서, 시간표      |
| **5일차** | [프로젝트 완성 및 발표](05%EC%9D%BC%EC%B0%A8%20-%20%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%20%EC%99%84%EC%84%B1%20%EB%B0%8F%20%EB%B0%9C%ED%91%9C.md)                  | 프로젝트 개발 및 완성<br>발표 및 피드백<br>5일간 회고                                 | 완성된 개인 프로젝트        |

---

## 🙋 명단

| 조   | 순번  | 성명  | 나이    | 학교명     | 학과       | 학적상태 | 성별  | 비고  |
| --- | --- | --- | ----- | ------- | -------- | ---- | --- | --- |
| 1조  | 1   | 김선엽 | 만 29세 | 대전대학교   | 군사학과     | 졸업   | 남성  | 조장  |
|     | 2   | 김희원 | 만 25세 | 고려대학교   | 환경시스템공학과 | 졸업   | 남성  |     |
|     | 3   | 문정서 | 만 21세 | 목원대학교   | 영어학과     | 휴학   | 여성  |     |
|     | 4   | 임준열 | 만 24세 | 한남대학교   | 빅데이터응용학과 | 졸업   | 남성  |     |
| 2조  | 5   | 김정동 | 만 24세 | 대전대학교   | 정보통신공학과  | 재학   | 남성  | 조장  |
|     | 6   | 임수빈 | 만 24세 | 목원대학교   | 의생명보건학부  | 졸업   | 여성  |     |
|     | 7   | 김한성 | 만 29세 | 목원대학교   | 신학과      | 졸업   | 남성  |     |
|     | 8   | 권우진 | 만 26세 | 대전대학교   | 경영학과     | 졸업   | 남성  |     |
| 3조  | 9   | 김지빈 | 만 21세 | 백석예술대학교 | 뮤지컬과     | 졸업   | 남성  | 조장  |
|     | 10  | 최병욱 | 만 28세 | 우송대학교   | -        | 중퇴   | 남성  |     |
|     | 11  | 이대경 | 만 24세 | 대전대학교   | 정보통신공학과  | 재학   | 남성  |     |
|     | 12  | 한대희 | 만 26세 | 우송대학교   | 국제경영학과   | 졸업   | 남성  |     |
...
**4일차**:
- ⚡ 오전 복습은 빠르게 진행 (핵심만)
- ⚡ 프로젝트 아이디어 브레인스토밍 시간 충분히 확보
- ⚡ MVP 개념 명확히 설명
- ⚡ 내일 바로 개발할 수 있도록 준비 완료 필수
